...
> Процес розробки: GSD (планування) + Superpowers (код) — див. розділ 21
...
## 21. Процес розробки (GSD + Superpowers)

### 21.1. Ролі скилів

| Скил | Коли використовувати |
|-------|----------------------|
| **GSD** (plan-phase, execute-phase, verify) | Планування і виконання фаз/мілстоунів проекту |
...
### 21.2. Правила роботи (заборонено порушувати)
...
6. **Build перед коммітом** — npm run build має проходити без помилок.
7. **Після деплою** — перевір що гра онлайн (200 OK).
8. **Кожна зміна — окремий комміт** з описом що і чому.

### 21.3. Патерн виправлення бага (обов'язковий)
